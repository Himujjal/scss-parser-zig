...
const AtKeywordTypes = @import("./token.zig").AtKeywordTypes;
...
pub fn initAtKeywordRadixTree() StringRadixTree(AtKeywordTypes) {
    comptime var radix = StringRadixTree(ATKT){};
    _ = comptime radix.insert("charset", ATKT.Charset);
    _ = comptime radix.insert("import", ATKT.Import);
    _ = comptime radix.insert("namespace", ATKT.Namespace);
    _ = comptime radix.insert("media", ATKT.Media);
    _ = comptime radix.insert("supports", ATKT.Supports);
    _ = comptime radix.insert("document", ATKT.Document);
    _ = comptime radix.insert("page", ATKT.Page);
    _ = comptime radix.insert("font-face", ATKT.FontFace);
    _ = comptime radix.insert("keyframes", ATKT.Keyframes);
    _ = comptime radix.insert("viewport", ATKT.Viewport);
    _ = comptime radix.insert("counter-style", ATKT.CounterStyle);
    _ = comptime radix.insert("font-feature-value", ATKT.FontFeatureValue);
    _ = comptime radix.insert("alternates", ATKT.Alternates);
    _ = comptime radix.insert("property", ATKT.Property);
    _ = comptime radix.insert("color-profile", ATKT.ColorProfile);
    _ = comptime radix.insert("layer", ATKT.Layer);
    return radix;
}
